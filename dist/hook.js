...
var _logging = _interopRequireDefault(require("./logging.js"));
...
function generate(hookName) {
  return new _sideUtils.codeExport.hook(emitters[hookName]());
}
...
function beforeEach() {
  const params = {
    ...
    endingSyntax: {
      commands: [{
        level: 0,
        statement: '// logging declartion ends here'
      }]
    },
    registrationLevel: 0
  };
...
function inEachBegin() {
  const params = {
    ...
    endingSyntax: {
      commands: [{
        level: 0,
        statement: '// inEachBegin()  ends here'
      }]
    },
    registrationLevel: 0
  };
  ...
  const params = {
    startingSyntax: {
      commands: [{
        ...
        level: 0,
        statement: '// Feel free to explore, or check out the full documentation'
      }, {
        level: 0,
        statement: '// https://docs.newrelic.com/docs/synthetics/new-relic-synthetics/scripting-monitors/writing-scripted-browsers'
      }, {
        level: 0,
  ...
  const params = {
    startingSyntax: {
      commands: [{
        ...
        level: 0,
        statement: 'const urlRequest = require("urllib").request;'
      }, {
        level: 0,
        ...
        level: 0,
        statement: 'var DefaultTimeout = 30000;'
      }, {
        level: 0,
        statement: '// Change to any User Agent you want to use.'
      }, {
        level: 0,
        statement: '// Leave as "default" or empty to use the Synthetics default.'
      }, {
        level: 0,
        statement: 'var UserAgent = "default";'
      }, {
        level: 0,
        statement: 'const By = $driver.By;'
      }, {
        level: 0,
        statement: 'const browser = $browser.manage();'
      }, {
        level: 0,
